...
export default class Cart {
  ...
  private getStorageData() {
    this.cartItems = JSON.parse(this.storage.getItem('rss-online-cart-data') as string) || [];
    this.cartPromo = JSON.parse(this.storage.getItem('rss-online-cart-promo') as string) || [];
  }
